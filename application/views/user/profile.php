                ...
                <div class="card-body px-5 pt-5">
                    <form action="" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control <?= (form_error('ttl')) ? 'is-invalid' : '' ?>" id="ttl" name="ttl" value="<?= set_value('ttl');  ?>" autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control text-capitalize <?= (form_error('agama')) ? 'is-invalid' : '' ?>" id="agama" name="agama" value="<?= set_value('agama');  ?>" autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control <?= (form_error('pendidikan')) ? 'is-invalid' : '' ?>" id="pendidikan" name="pendidikan" value="<?= set_value('pendidikan');  ?>" autocomplete="off">
