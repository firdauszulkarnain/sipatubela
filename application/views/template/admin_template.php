    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?= base_url() ?>admin/dashboard" class="brand-link">
                ...
                <span class="brand-text">SIPATUBELA</span>
            </a>
                            ...
                            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="<?= base_url() ?>pengguna/data" class="nav-link <?= $this->uri->segment(1) == 'pengguna'  && $this->uri->segment(2) == 'data' ? "active" : "" ?>">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; <?= date('Y') ?> SIPATUBELA All rights reserved.
        </footer>
